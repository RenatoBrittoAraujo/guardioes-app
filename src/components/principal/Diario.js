...
class Diario extends Component {
  ...
  defineMarkedDates = () => {
    ...
    let BadReport = markedDate.reduce(
      (c, v) =>
        Object.assign(c, {[v]: {selected: true, selectedColor: '#BF092E'}}),
      {},
    );
    let GoodReport = markedDateNo.reduce(
      (c, v) =>
        Object.assign(c, {[v]: {selected: true, selectedColor: '#058B09'}}),
      {},
    );
        ...
        <ScrollView>
          ...
          <View>
            <View style={styles.LeftTop}>
              <View>
                <Text style={styles.NumReports}>
                  {' '}
                  {this.state.totalReports} {translate('diary.participate')}{' '}
                </Text>
              </View>
              <View style={styles.UserReport}>
                <View style={styles.UserData}>
                  <Image
                    ...
                    source={Imagem.imagemGood}
                  />
                  <View style={styles.columnData}>
                    <Text style={styles.percentReport}>
                      {this.state.GoodPercent}% {translate('diary.good')}
                    </Text>
                    <Text style={styles.numGood}>
                      {' '}
                      {this.state.NummarkedDateNo === 1
                        ? this.state.NummarkedDateNo + translate('diary.report')
                        : this.state.NummarkedDateNo +
                ...
                <View style={styles.UserData}>
                  <Image
                    style={{width: 75, height: 85}}
                    source={Imagem.imagemBad}
                  />
                  <View style={styles.columnData}>
                    <Text style={styles.percentReport}>
                      {this.state.BadPercent}% {translate('diary.bad')}
                    </Text>
                    <Text style={styles.numBad}>
