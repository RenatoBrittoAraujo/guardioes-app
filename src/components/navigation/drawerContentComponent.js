        ...
        <LinearGradient
          ...
          <TouchableOpacity
            ...
            <MaterialIcons
              ...
              style={styles.iconStyle}
            />
            <Text style={styles.drawerItemsTxt}>
              {translate('drawer.healthMap')}
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            style={styles.itemsContainer}
            onPress={() =>
              Linking.openURL('https://www.facebook.com/AssociacaoProEpi/')
            }>
            <Entypo
              name="facebook"
              size={verticalScale(25)}
          ...
          <TouchableOpacity
            ...
            <Entypo
              ...
              size={verticalScale(25)}
              color="gray"
              style={[styles.iconStyle, {paddingRight: '16%'}]}
            />
            <Text style={styles.drawerItemsTxt}>
          ...
          <View
            ...
            <Text
              style={[
                styles.drawerItemsTxt,
                {fontSize: 20, fontWeight: 'bold'},
              ]}
              onPress={this._logoutApp}>
