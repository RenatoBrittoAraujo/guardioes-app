...
class Home extends Component {
  ...
  getInfos = async () => {
    ...
    await this.setState({
      userSelect: this.state.userName,
      avatarSelect: this.state.userAvatar,
    });
  ...
  render() {
    ...
    const householdHowYouFellingText =
      translate('home.householdHowYouFelling_part_1') +
      this.state.householdName +
      translate('home.householdHowYouFelling_part_2');
    ...
    const userIsProfessional = (
      <View style={styles.rumorView}>
        <TouchableOpacity
          ...
          <Text
            style={{color: 'white', fontFamily: 'roboto', marginLeft: '6%'}}>
            {translate('home.reportRumor')}
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() =>
            Alert.alert('', translate('home.reportRumorMessage'), [
    ...
    const householdHowYouFelling = (
      <Text style={styles.textFelling}>{householdHowYouFellingText}</Text>
    );
    ...
    return (
      <View style={styles.container}>
        ...
        <FontAwesome
          ...
          size={scale(30)}
          color="rgba(22, 107, 135, 0.2)"
          style={{alignSelf: 'flex-start', marginLeft: '3%', marginTop: '2%'}}
        />

        <View style={styles.viewImage}>{imageType}</View>

        <View style={styles.viewWelcome}>
          <Text style={styles.textHelloUser}>{welcomeMessage}</Text>
                              ...
                              <Avatar
                                ...
                                onPress={async () => {
                                  await this.setState({
                                    ...
                                    userSelect: household.description,
                                    avatarSelect: household.picture,
                                  });
        ...
        <View style={styles.viewReport}>
          <View style={styles.viewChildGood}>
            <TouchableOpacity //onPress={this._isconnected}
              ...
              <Text style={styles.textChoiceButton}>
          ...
          message={
            this.state.showProgressBar ? null : (
              <Text style={{alignSelf: 'center'}}>
                {translate('badReport.alertMessages.reportSent')} {emojis[0]}
                {emojis[0]}
                {emojis[0]}
              </Text>
            )
