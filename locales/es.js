export default {
  ...
  tutorial: {
    ...
    howToUse2:
      'A continuación, elija cómo informar, bien o mal. \
    ...
    newsCont:
      'La pantalla de noticias es una de las funciones que usted encuentra en la pantalla de inicio, que está vinculada en el perfil de Twitter del Ministerio de Salud y allí usted puede ver muchas informaciones porque siempre actualizan esa página. \
    ...
    advicesCont:
      'Aquí encontrará algunas informaciones importantes para echar un vistazo, como Dengue Chicungunya y Zyca, teléfonos útiles y también, con ayuda de Google Maps usted tiene acceso a hospitales y farmacias cerca de usted.',
